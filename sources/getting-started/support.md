...
Each minion has 2 cores and 4GB RAM, unless you upgrade your subscription to a higher tier. If you use your own infrastructure to run your builds with [BYON Nodes](/platform/runtime/nodes/#custom-nodes) option, you can spin up bigger containers for your builds since we do not restrict resources for containers running on customers' infrastructure.
