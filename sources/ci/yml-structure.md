...
| [**depth:**](set-git-options/) | no default | Set to a positive integer for the repository to be shallow cloned. [Read more](set-git-options/) |
| [**gitConfig:**](set-git-options/) | no default | Set to the list of git configs that are to be set globally before the repo is cloned. [Read more](set-git-options/) |
