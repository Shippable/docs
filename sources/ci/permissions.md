...
If you want to build repositories in your [GitHub Enterprise](/platform/integration/github-enterprise/) instance, you will still need to sign in with GitHub or Bitbucket and add an [integration](/platform/integration/overview) for GitHub Enterprise.
