...
[**Unmanaged jobs environment variables**](/platform/jobs-unmanaged/) are environment variables that can be used in [runCI](/platform/workflow/job/runci/), [runSH](/platform/workflow/job/runsh/) and [runCLI](/platform/job-cli/) jobs.
