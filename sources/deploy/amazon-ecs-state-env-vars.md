page_main_title: Amazon ECS Working with state and environment variables
main_section: Deploy
...
Managed jobs maintain their own state, and it cannot be customized.  To set environment variables for managed jobs, use the [params](../platform/workflow/resource/params) resource.  This resource type can be applied to manifests or individual images within a manifest.  They can be overridden as your pipeline moves from one environment to another, and they have support for secure encrypted variables.
