...
<img width="75%" height="75%" src="../../images/platform/integrations/account-settings.png" alt="Add Kubernetes credentials">

* Select **deploy** as the Integration family.
* Choose **Kubernetes** from the list of integration types.
...
<img src="../../images/platform/integrations/kubernetes-integration.png" alt="Add Kubernetes integration">
...
<img width="75%" height="75%" src="../../images/platform/integrations/account-settings.png" alt="Add Kubernetes integration">
...
<img src="../../images/platform/integrations/kubernetes-bastion-integration.png" alt="Add Kubernetes integration">
...
Click on **Integrations** in the left sidebar menu and then click on your integration. You can then change integration name and contents of kube file and ip address to log into bastion node.
