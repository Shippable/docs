...
Job Images with Ansible CLI pre-installed are available for multiple operating systems, languages and versions. Each os-language-version combination is published in Docker hub as an image with a specific tag. The Docker hub account where we publish these images is `drydock`.
...
Ansible CLI is available on the drydock links specified below for these OS and language versions.
...
|----------|---------|-----------|
|2.3.0.0  | v5.7.3 v5.6.1 v5.5.1 | Ubuntu 14.04 and Ubuntu 16.04 |
