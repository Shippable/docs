page_main_title: Postgres Service Overview
main_section: Platform
sub_section: Job Runtime
sub_sub_section: Services
page_title: Postgres Service Overview

# Postgres Job Images

Job Images for Postgres are available for multiple operating systems, languages and versions. Each os-language-version combination is published in Docker hub as an image with a specific tag. The Docker hub account where we publish these images is drydock.
...
Postgres service is available on the drydock links specified below for these OS and language versions.
...
|----------|---------|-----------|---------------------|
|9.6.3  | v5.7.3 | All | [v5.7.3](/platform/machine-image-v573) |
|9.6  | v5.6.1 and earlier | All | [v5.6.1](/platform/machine-image-v561) and earlier |
