page_description: Creating Kubernetes Integration on Shippable
...
If you need to know how to generate a KubeConfig file, follow this [tutorial](/deploy/tutorial/create-kubeconfig-for-self-hosted-kubernetes-cluster)
