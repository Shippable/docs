page_main_title: Redis Service Overview
...
Redis is available as an [optional service](/ci/redis) that you can start as part of your CI process. All language images and all Operating Systems support this service
