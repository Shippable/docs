page_main_title: MySQL Service Overview
...
# MySQL Job Images
MySQL is available as an [optional service](/ci/mysql) that you can start as part of your CI process. All language images and all Operating Systems support this service
