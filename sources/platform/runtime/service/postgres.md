...
Postgres is available as an [optional service](/ci/postgres) that you can start as part of your CI process. All language images and all Operating Systems support this service
