page_main_title: Docker CLI Overview
main_section: Platform
sub_section: Job Runtime
sub_sub_section: CLIs
page_title: Docker CLI Overview

# Docker CLI

Job Images with Docker CLI pre-installed are available for multiple operating systems, languages and versions. Each os-language-version combination is published in Docker hub as an image with a specific tag. The Docker hub account where we publish these images is `drydock`.
...
Docker CLI is available on the drydock links specified below for these OS and language versions.
...
|----------|---------|-----------|
|1.13.0  | v5.7.3 and below | Ubuntu 14.04 and Ubuntu 16.04 |
