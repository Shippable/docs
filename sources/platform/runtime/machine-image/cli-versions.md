...
| Version  | OS   | Machine Images
|----------|---------|-----|
| 3.0.0     | - Ubuntu 16.04 (aarch64) <br>- Ubuntu 16.04 (aarch32) | [v6.4.4](/platform/runtime/machine-image/ami-v644/) to [v6.7.4](/platform/runtime/machine-image/ami-v674/) <br> [v6.5.4](/platform/runtime/machine-image/ami-v654/) to [v6.7.4](/platform/runtime/machine-image/ami-v674/)
...
| Version  | OS |  Machine Images
|----------|---------|-------------|
| 17.10.0-ce | - Windows 16 | [v6.5.4](/platform/runtime/machine-image/ami-v654/) to [v6.7.4](/platform/runtime/machine-image/ami-v674/)
...
| Version  | OS |  Machine Images
|----------|---------|---|
| 1.17.0  | - CentOS 7<br>- Ubuntu 14.04 <br>- Ubuntu 16.04 <br> -Windows 16 | [v6.7.4](/platform/runtime/machine-image/ami-v674/)
...
| Version  | OS |  Machine Images
|----------|---------|----|
| 1.11.0  | - CentOS 7 <br>- Ubuntu 14.04 <br>- Ubuntu 16.04 <br>- Ubuntu 16.04 (aarch64) <br>- Windows 16  | [v6.7.4](/platform/runtime/machine-image/ami-v674/)
...
| Version  | OS | Machine Images
|----------|---------|-------------|
| 0.11.7 | - CentOS 7<br>- Ubuntu 14.04  <br>- Ubuntu 16.04 <br>- Windows 16  |  [v6.5.4](/platform/runtime/machine-image/ami-v654/) to [v6.7.4](/platform/runtime/machine-image/ami-v674/)
