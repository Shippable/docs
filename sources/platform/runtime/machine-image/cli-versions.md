...
Note:- On platforms other than Windows the Docker binary is mounted from the host. The version of Docker that will be available to your build depends on the runtime version configured on your node pool. Please refer to the [machine images](/platform/overview/) documentation for more information.
