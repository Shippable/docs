...
| Version|              OS            | Machine Images       
|-------|----------------------------|---------------------
|6.4.3  | -  CentOS 7 <br>- Ubuntu 14.04 <br>- Ubuntu 16.04  | [v6.11.4](/platform/runtime/machine-image/ami-v6114/)
...
| Version  |     OS   | Machine Images         
|----------|----------|-----------------
|1.5.12     |- CentOS 7<br>- Ubuntu 14.04<br>- Ubuntu 16.04<br>- Ubuntu 16.04(aarch 64) |[v6.11.4](/platform/runtime/machine-image/ami-v6114/)
...
| Version  |  OS     | Machine Images
|----------|---------|-------------------
|4.0.3 |- CentOS 7<br>- Ubuntu 14.04<br>- Ubuntu 16.04 <br>- Ubuntu 16.04(aarch64) |[v6.10.4](/platform/runtime/machine-image/ami-v6104/) and [v6.11.4](/platform/runtime/machine-image/ami-v6114/)
...
| Version  |  OS  | Machine Images
|----------|---------| ------
|5.7.24| - CentOS 7<br>- Ubuntu 14.04<br>- Ubuntu 16.04 |[v6.11.4](/platform/runtime/machine-image/ami-v6114/)
...
Note: Neo4j is not supported on v6.8.4 to v6.11.4 images because it is incompatible with Java 10 and Java 11. You can use openjdk8 on an earlier machine image if you need these versions of Neo4j.

## Postgres

| Version  |    OS    |   Machine Images
|----------|---------|------------
|10.6 |- CentOS 7<br>- Ubuntu 14.04<br>- Ubuntu 16.04  | [v6.11.4](/platform/runtime/machine-image/ami-v6114/)
