...
We have the following base images, one for each supported OS version.
 ...
 | Windows 16 | drydock/w16:v6.11.4 | - [Docker Hub](https://hub.docker.com/r/drydock/w16/),<br>- [GitHub](https://github.com/dry-dock/w16) |  |- git 2.19.2<br>- git-lfs 2.6.0<br>- gcloud 225.0.0<br>- awscli 1.16.60<br>- Azurecli 2.0.51<br>- kubectl 1.12.1<br>- jfrog-cli 1.12.1<br>-  terraform 0.11.9<br>- packer 1.3.2<br>- jq 1.5.0 | |
