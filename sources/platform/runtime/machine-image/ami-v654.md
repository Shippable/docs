...
We have the following base images, one for each supported OS version.
 ...
 | Windows 16 | drydock/w16:v6.5.4| - [Docker Hub](https://hub.docker.com/r/drydock/w16/),<br>- [GitHub](https://github.com/dry-dock/w16) |  |- git-lfs 2.4.0<br>- gcloud 202.0.0<br>- awscli 1.15.20<br>- Azurecli 2.0.32<br>- kubectl 1.10.0<br>- jfrog-cli 1.11.2<br>-  terraform 0.11.7<br>- packer 1.2.3<br>- jq 1.5.0 | |
 ---
...
| OS           | Image                    | Link                                                                                                          | Language versions      | Additional packages                                                     |
|--------------|--------------------------|---------------------------------------------------------------------------------------------------------------|------------------------|-------------------------------------------------------------------------|
| Windows 16 | dry-dock/w16dotnetcore:v6.5.4 | - [Docker Hub](https://hub.docker.com/r/drydock/w16dotnetcore/),<br>- [GitHub](https://github.com/dry-dock/w16dotnetcore) | - .NET Core SDK 2.1.00 | - [Common components](#common-644)<br> |
