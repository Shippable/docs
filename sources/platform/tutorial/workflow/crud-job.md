...
Once **shippable.yml** is committed to a repository, you will have to add it to Shippable through the UI. Detailed step by step instructions are [here](/platform/tutorial/workflow/add-assembly-line).
