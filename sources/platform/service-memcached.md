page_main_title: Memcached Service Overview
main_section: Platform
sub_section: Job Runtime
sub_sub_section: Services
page_title: Memcached Service Overview

# Memcached Job Images
...
Memcached service is available on the drydock links specified below for these OS and language versions.
...
|----------|---------|-----------|---------------------|
|1.4.39  | v5.7.3  | All | [v5.7.3](/platform/machine-image-v573) |
|1.4.34  | v5.6.1 and earlier | All | [v5.6.1](/platform/machine-image-v561) and earlier |
