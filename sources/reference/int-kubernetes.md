...
<img width="75%" height="75%" src="../../images/reference/integrations/account-settings.png" alt="Add Kubernetes credentials">
...
<img width="75%" height="75%" src="../../images/reference/integrations/account-settings.png" alt="Add Kubernetes integration">
